...
urlpatterns = patterns('',
    ...
    url(r'^profesor/borrar-alumno/(?P<curso_id>\d+)/(?P<alumno_id>\d+)/$', vv.BorrarAlumnoView.as_view(), name='borrar_alumno'),
    ...
    url(r'^profesor/editar-alumno/(?P<curso_id>\d+)/(?P<alumno_id>\d+)/$', vv.EditarAlumnoView.as_view(), name='editar_alumno'),
