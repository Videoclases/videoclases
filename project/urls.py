...
urlpatterns = patterns('',
    ...
    url(r'^student/send-videoclase/(?P<homework_id>\d+)/$', vv.EnviarVideoclaseView.as_view(), name='enviar_videoclase'),
    ...
    url(r'^teacher/edit-student/(?P<course_id>\d+)/(?P<student_id>\d+)/$', vv.EditarAlumnoView.as_view(), name='editar_student'),
    url(r'^teacher/edit-course/(?P<course_id>\d+)/$', vv.EditarCursoView.as_view(), name='editar_course'),
    url(r'^teacher/edit-group-form/', vv.EditarGrupoFormView.as_view(), name='editar_group_form'),
    url(r'^teacher/edit-homework-form/(?P<homework_id>\d+)/$', vv.EditarTareaView.as_view(), name='editar_homework_form'),
